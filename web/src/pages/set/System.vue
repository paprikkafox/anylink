<template>
  <div>
    <el-row :gutter="10" class="mb10">
      ...
      <el-col :span="8">
        <el-card v-if="system.mem" body-style="text-align: center;">
          ...
          <Cell left="remaining memory" :right="system.mem.free"/>
        </el-card>
      </el-col>
      ...
      <el-col :span="8">
        <el-card v-if="system.disk" body-style="text-align: center;">
          ...
          <Cell left="remaining storage" :right="system.disk.free"/>
        </el-card>
      </el-col>
    ...
    <el-card v-if="system.sys" style="margin-top: 10px">
      ...
      <Cell left="Software version" :right="system.sys.appVersion" divider/>
      <Cell left="SoftwareCommitId" :right="system.sys.appCommitId" divider/>
