...
const (
	...
	UserConnected      = 2 // Connected successfully
	UserLogout         = 3 // User logs out
	UserLogoutLose     = 0 // The user is offline
...
var (
	UserActLogIns = &UserActLogProcess{
		...
		InfoOps: []string{ // Information
			UserLogoutLose:     "User dropped offline",
			...
			UserLogoutExpire:   "Account expired and kicked offline",
