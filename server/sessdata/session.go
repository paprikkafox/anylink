...
type ConnSession struct {
	...
	BandwidthDown       atomic.Uint32 // Use downstream bandwidth Byte
	...
	BandwidthDownAll    atomic.Uint64 // Total amount of downlink bandwidth used
	closeOnce           sync.Once
...
type Session struct {
	...
	UniqueIdGlobal  string // Client's unique identifier
