...
var configs = []config{
	...
	{Typ: cfgStr, Name: "admin_addr", Usage: "WebUI listening address", ValStr: ":8800"},
	...
	{Typ: cfgStr, Name: "issuer", Usage: "System name", ValStr: "XX公司VPN"},
	...
	{Typ: cfgStr, Name: "admin_otp", Usage: "Manage user OTP, generate commands	./anylink tool -o", ValStr: ""},
	{Typ: cfgStr, Name: "jwt_secret", Usage: "JWT Secret", ValStr: defaultJwt},
	{Typ: cfgStr, Name: "link_mode", Usage: "Virtual network type[tun tap macvtap ipvtap]", ValStr: "tun"},
	{Typ: cfgStr, Name: "ipv4_master", Usage: "IPv4 main network interface name", ValStr: "eth0"},
	...
	{Typ: cfgInt, Name: "mobile_keepalive", Usage: "Mobile keepalive time (seconds)", ValInt: 4},
	{Typ: cfgInt, Name: "mobile_dpd", Usage: "Mobile dead link detection time (seconds)", ValInt: 60},
	...
	{Typ: cfgInt, Name: "audit_interval", Usage: "Audit deduplication interval (seconds), -1 turns off", ValInt: 600},
